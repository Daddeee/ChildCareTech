...
/**
 * Black-box test of {@link AdultController#doGetAllAdults()} .
 */
public class DoGetAllAdultsTest extends AbstractControllerActionTest {
    ...
    public void testAction() {
        ...
        List<AdultDTO> expectedEmpty = adultController.doGetAllAdults();
        ...
        List<AdultDTO> expectedResult = new ArrayList<>();
        expectedResult.add(DTOFactoryFacade.getDTO(a1));
        expectedResult.add(DTOFactoryFacade.getDTO(a2));
        expectedResult.add(DTOFactoryFacade.getDTO(a3));
        expectedResult.add(DTOFactoryFacade.getDTO(a4));

        List<AdultDTO> result = adultController.doGetAllAdults();
